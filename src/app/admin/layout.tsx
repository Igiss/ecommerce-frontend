...
import { LayoutDashboard, ShoppingCart, Calendar, Ticket, ArrowLeft, Loader2, LogOut, Shield } from 'lucide-react'
...
export default function AdminLayout({ children }: AdminLayoutProps) {
  ...
  const sidebarLinks = [
    ...
    { href: '/admin/products', label: 'Sản phẩm', icon: ShoppingCart },
    { href: '/admin/orders', label: 'Đơn hàng', icon: Calendar },
