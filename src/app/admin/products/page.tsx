...
const CATEGORIES = ['Ly sứ', 'Ly giữ nhiệt', 'Ly thủy tinh', 'Ly nhựa', 'Bộ ly', 'Ly cafe', 'Phụ kiện']
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-black text-stone-900 tracking-tight">Quản lý Sản phẩm</h1>
          <p className="text-xs text-stone-500 mt-1">Danh sách sản phẩm và các chức năng thêm, sửa, xóa danh mục cốc.</p>
        </div>
        <button
      ...
      {loading ? (
        ...
        <div className="text-center py-16 border border-stone-200 border-dashed rounded-2xl bg-white">
          <p className="text-stone-550 text-sm">Chưa có sản phẩm nào được tạo.</p>
        </div>
      ) : (
